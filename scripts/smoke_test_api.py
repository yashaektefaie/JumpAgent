...
TESTS = [
    ...
    ("POST", "/mcp", {"jsonrpc": "2.0", "id": 3, "method": "tools/call", "params": {"name": "resolve_entity", "arguments": {"q": "JCP2022_085227", "limit": 3}}}),
    ("GET", "/datasets", None),
    ("GET", "/workflows", None),
    ("GET", "/memos?limit=3", None),
    ...
    ("POST", "/metadata/summary", {"table": "compound_source", "group_by": ["Metadata_Compound_Source"], "limit": 3}),
    ("POST", "/chemical/properties", {"ids": ["JCP2022_085227"]}),
    ("POST", "/annotations", {"table": "repurposing_hub_annotations", "ids": ["JCP2022_085227"]}),
    ("POST", "/annotations/coverage", {"group_by": "compound_source", "sources": ["repurposing", "chembl"], "limit": 3}),
    ("POST", "/wells/cell-counts", {"ids": ["JCP2022_085227"], "limit": 3}),
    ("POST", "/similarity/neighbors", {"id": "JCP2022_085227", "modality": "compound", "top_k": 3}),
    ("POST", "/workflows/neighborhood", {"id": "JCP2022_085227", "modality": "compound", "top_k": 3, "include_features": False, "include_gallery": False}),
